...
```bash
# (optional) confirm the file opens, e.g.:
python3 -c "import docx; docx.Document('seo-audit-[domain]-[date].docx')"
```
...
```bash
soffice --headless --convert-to pdf ./seo-audit-[domain]-[date].docx --outdir ./   # LibreOffice; PDF optional
```
...
[Download Word Doc](./seo-audit-[domain]-[date].docx)
[Download PDF](./seo-audit-[domain]-[date].pdf)
```
